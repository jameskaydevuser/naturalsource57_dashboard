...
import { updateProduct } from 'src/firebase/product';
...
export default function UpdateProductModal({ product, open, setOpen }) {
  ...
  useEffect(() => {
    setImageUrl(product?.information?.imageUrl);
    setName(product?.information?.name);
    setDescription(product?.information?.description);
    setCategory(product?.information?.category);
    setPrice(product?.price?.price);
    setQuantity(product?.quantity);
    setShippingFee(product?.shipping_fee);
    setTHC(product?.information?.thc);
    setCBD(product?.information?.cbd);
  }, [product]);
      ...
      <DialogContent>
        <Form onSubmit={handleSubmit}>
          ...
          <TextField
            ...
            required
          />
          <TextField type="number" label="THC %" name="thc" value={thc} onChange={e => setTHC(e.target.value)} />
          <TextField type="number" label="CBD %" name="cbd" value={cbd} onChange={e => setCBD(e.target.value)} />
          <TextField
            type="number"
            label="Price"
            name="price"
          ...
          <TextField
            type="number"
            label="Quantity (fill empty to set unlimited)"
            name="quantity"
            value={quantity}
          ...
          {/* <TextField type="text" label="Address" name="address" defaultValue="Westhill" /> */}

          {/* <FormControlLabel
            control={<Checkbox name="is_contactable" defaultChecked={false} />}
